...
class UserSchemaEmail(BaseModel):
    full_name: Annotated[str, Field (default= "your_full_name" , pattern="^[a-zA-Z0-9 ]+$", min_length=2, max_length=64)]
...
class UserSchemaTelegram(BaseModel):
    full_name: Annotated[str, Field (default= "your_full_name" , pattern="^[a-zA-Z0-9 ]+$", min_length=2, max_length=64)]
    telegram: Annotated[str, Field (default= "your_telegram" , pattern="^@+[a-zA-Z0-9]+[a-zA-Z0-9_]+$", min_length=5, max_length=32)]
    password: Annotated[str, Field (default= "your_password" , pattern="^[a-zA-Z0-9]+$", min_length=8, max_length=100)]
